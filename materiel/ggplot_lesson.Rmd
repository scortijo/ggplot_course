...
La fonction `theme()` peut être utilisée pour modifier des éléments en particulier du graphique. Il y a tellement de possibilité que le mieux est de rechercher sur internet la modification que vous voulez faire.  
