...
Téléchargez le matériel de la formation en cliquant sur `Download.zip` ou `Download.tar.gz`, dezpipez le répertoire et ensuite placer vous dedans. Ouvrez avec `Rstudio` le fichier `Script_ggplot_lesson.R` qui est dans le répertoire `materiel`. Nous allons coder ensemble dans ce script, qui est quasiment vide pour le moment. 
